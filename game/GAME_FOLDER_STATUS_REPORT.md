...
**Path:** `C:\Users\steve\MeWorld\game\`  
**Repo:** Git lives in `game/` — `C:\Users\steve\MeWorld` itself is **not** a git repo.
...
**`C:\Users\steve\MeWorld\game\src\`**
...
| Project | Path | Git |
|---------|------|-----|
| **TheSchoonMaker (game)** | `C:\Users\steve\MeWorld\game\` | Yes — `BeizaPlus/TheSchoonMaker` |
| **clinical-scene** | `C:\Users\steve\Downloads\clinical-scene\` | Yes — separate repo |
| **MeWorld (parent)** | `C:\Users\steve\MeWorld\` | No git repo |
...
- To launch game dev server: `cd "C:\Users\steve\MeWorld\game"` then `npm run dev`
