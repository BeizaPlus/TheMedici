/** Tabler Icons (outline, 24×24, stroke 2) — https://tabler.io/icons
 *  Mic: https://tabler.io/icons/icon/microphone
 *  Stop: https://tabler.io/icons/icon/player-stop
 */
...
/** Tabler: clipboard-list — orders / treatment stacks — https://tabler.io/icons/icon/clipboard-list */
...
/** @deprecated use IconClipboardList — Tabler pill https://tabler.io/icons/icon/pill */
...
/** Tabler: stack-2 — differential stack — https://tabler.io/icons/icon/stack-2 */
export function IconDifferentialStack(props) {
  return (
    <svg className="toolbar-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}>
...
export function IconPatientUser(props) {
  return (
    <svg
...
/** Tabler: arrows-shuffle — random case pick — https://tabler.io/icons/icon/arrows-shuffle */
...
/** Tabler: circle-check — case avatar selected — https://tabler.io/icons/icon/circle-check */
...
export function IconPlayerStop(props) {
  return (
    <svg className="toolbar-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}>
...
export function IconPlayerPause(props) {
  return (
    <svg className="toolbar-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}>
...
export function IconPlayerPlay(props) {
  return (
    <svg className="toolbar-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}>
...
/** @deprecated use IconPlayerStop */
export const IconSquare = IconPlayerStop;

export function IconVolume2(props) {
  return (
    <svg className="toolbar-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}>
      <path d="M15 8a5 5 0 0 1 0 8" />
      <path d="M6 15h-2a1 1 0 0 1 -1 -1v-4a1 1 0 0 1 1 -1h2l3.5 -4.5a1.1 1.1 0 0 1 1.7 0v13a1.1 1.1 0 0 1 -1.7 0l-3.5 -4.5" />
    </svg>
  );
}
...
export function IconCopy(props) {
  return (
    <svg className="toolbar-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}>
      ...
      <path d="M4.012 16.737a2.005 2.005 0 0 1 -1.401 -1.935v-9.201a2 2 0 0 1 1.4 -1.933l9.962 -1.933a2 2 0 0 1 2.302 1.933" />
    </svg>
  );
}

/** Tabler: bookmark — review queue — https://tabler.io/icons/icon/bookmark */
...
/** Tabler: x — close — https://tabler.io/icons/icon/x */
...
/** Tabler: puzzle — Build the Picture mode — https://tabler.io/icons/icon/puzzle */
...
/** Tabler: timeline — practice log — https://tabler.io/icons/icon/timeline */
export function IconTimeline(props) {
  return (
    <svg className="toolbar-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}>
      <path d="M4 16l6 -6l4 4l8 -8" />
      <path d="M4 20h16" />
    </svg>
  );
}

/** Tabler: world — real-world stories — https://tabler.io/icons/icon/world */
...
export function IconArrowsMove(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden {...props}>
      <path d="M12 2v20M2 12h20M19 5l-3 3 3 3M5 19l3-3-3-3M19 19l-3-3 3-3M5 5l3 3-3 3" />
    </svg>
  );
}
...
/** Tabler: users-group — second attending / peer opinion — https://tabler.io/icons/icon/users-group */
export function IconUsersGroup(props) {
  return (
    <svg className="toolbar-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}>
      <path d="M10 13a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" />
      <path d="M8 21v-2a3 3 0 0 1 3 -3h2a3 3 0 0 1 3 3v2" />
      <path d="M5 10a3 3 0 1 0 6 0a3 3 0 1 0 -6 0" />
      <path d="M16 17v-2a3 3 0 0 1 2 -2.83" />
