...
export const STORAGE = {
  ...
  playDockLayout: 'schoonmaker_play_dock_layout_v2',
  briefingDockLayout: 'schoonmaker_briefing_dock_layout_v2',
  ...
  magneticRepositioning: 'schoonmaker_magnetic_repositioning',
};
