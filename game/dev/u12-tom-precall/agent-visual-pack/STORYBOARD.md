...
**Style:** `VISUAL_STYLE_LOCK.md` · global refs → `../../global-visual-refs/` · case pack → this folder  
**Narrative:** `NARRATIVE_LOCK.md`  
**Approval:** `APPROVAL.md` · **Rules:** `GENERATION_RULES.md` · **Select panels:** `PANEL_SELECTION.md`
...
| `outputs/u12-truck-brake-storyboard-grid-2x3.png` | Case-pack copy for approval |
...
| **2** | top-center | `s02-windshield-ant` · beat 2 | 0:02–0:04 | Something on the road | Driver **windshield POV** — tiny **ant** near **circular pavement manhole cover** (**not square**). **No HUD.** | **New gen** |
| **3** | top-right | `s03-hatch-ant` · beat 3 | 0:04–0:05 | The hatch | **Round** manhole cover edge lifted; **ant** scurries. Photoreal. **Circular only.** | **New gen** |
| **4** | bottom-left | `s03-foot-brake` · beat 4 | 0:05–0:06 | Hard brake (cut) | Worn boot **stomps brake pedal** fully down — low cab floor, amber dash underglow. | **Match v1 interior craft** — ref `outputs/u12-tom-truck-cab-still.png` + approved Kling lurch |
...
| `s06-hold` · beat 8 | 0:12–0:15 | Slump on wheel — bridge to hospital | **Reuse v1** — `outputs/u12-tom-truck-brake-5s-kling26.mp4` tail |
...
- **Tom identity:** craniofacial asymmetry, short goatee — character map + shipped game portrait
- **Truck kinematics:** **Oscar Ramos** refs for panels 1 and 5
- **v1 quality bar:** `outputs/u12-tom-truck-brake-5s-kling26.mp4` for interior brake-to-slump (beats 4–8 interior portions)

---

## Assembly (after Steve approves grid)

See `EXISTING_VIDEO.md` — v1 is the **interior brake-to-stop engine** bookended by cold open (beats 1–3) and comic tag (beat 7).
